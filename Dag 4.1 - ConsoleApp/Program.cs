...
string data2 = "12345John Smith          5000  3  ";
string updatedData = data2.Remove(5, 20);
...
int openingPosition2 = input2.IndexOf(openSpan);
int closingPosition2 = input2.IndexOf(closeSpan);

openingPosition2 += openSpan.Length;
int length2 = closingPosition2 - openingPosition2;
quantity = input2.Substring(openingPosition2, length2);
